...
while [ "$i" -lt "$max" ] #This checks if the "i" variable is less than the max variable"
	...
	then
		echo -n "ZZZ Secret Code: " >> ./"$output_file"
...
#README Time!
levelinstructions="The secret code is obfuscated by a lot of dummy lines again, this time, use the sort command to find it."
